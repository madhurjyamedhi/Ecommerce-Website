...
<div id="navbar" class="topnav">
  ...
  <div id="navbar-right">
    ...
    <a href="users/login.php">SignIn</a>
  </div>
</div>
<!-- ======================================== -->
<!-- ======================================== -->
...
<div class="hero-image">
	<button onclick="location.href='users/login.php';" >ORDER NOW!</button>
</div>
<!-- ======================================= -->
<!-- ======================================= -->
...
<div class="price-columns">
  <ul class="price">
    ...
    <li class="grey"><a href="users/login.php" class="button">ORDER NOW</a></li>
  </ul>
</div>
